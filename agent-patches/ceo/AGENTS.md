...
- On every spawn, read `./instructions/HEARTBEAT.md` (full path: check the instructions path directive in your prompt) first before any other action.
...
- `./instructions/HEARTBEAT.md` (full path: check the instructions path directive in your prompt) -- execution and extraction checklist. Run every heartbeat.
